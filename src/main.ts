...
document.querySelector<HTMLDivElement>('#app')!.innerHTML = `
  <div>
    ...
    <h2>Adição:</h2>
    <label>
      <input placeholder="Digite um número" id="addNumber1"> + <input placeholder="Digite um número" id="addNumber2">
      <Button id="calcAdd">Calcular</Button>
    </label>

    <h2>Subtração:</h2>
    <label>
      <input placeholder="Digite um número" id="subNumber1"> - <input placeholder="Digite um número" id="subNumber2">
      <Button id="calcSub">Calcular</Button>
    </label>

    <h2>Multiplicação:</h2>
    <label>
      <input placeholder="Digite um número" id="multNumber1"> x <input placeholder="Digite um número" id="multNumber2">
      <Button id="calcMult">Calcular</Button>
    </label>

    <h2>Divisão:</h2>
    <label>
      <input placeholder="Digite um número" id="divNumber1"> : <input placeholder="Digite um número" id="divNumber2">
